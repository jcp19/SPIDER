...
CSV_HEADER='Test Case, #events in the trace, #contraints, #msg-msg race candidates, #actual msg-msg race candidates, #Data races from msg races, time to check candidates, #removed events (RW + IT) (Redundant RW %), #contraints(R), #msg-msg race candidates(R), #actual msg-msg race candidates(R), #Data races from msg races, time to check candidates(R)'
